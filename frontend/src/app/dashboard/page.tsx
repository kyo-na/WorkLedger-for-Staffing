...
import { Users, Building2, Briefcase, DollarSign, Activity, ArrowUpRight } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  // ★ここが修正ポイント: 
  // バックエンドの集計(monthlySales)が0でも、グラフデータ(monthlyTrend)に値があればそれを使う
    ...
    <DashboardLayout>
      <div className="space-y-8 animate-in fade-in pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <KPICard 
            title="今月の売上予測" 
            // ★修正: displaySales変数を使用し、万単位に変換して表示
            ...
            <div className="bg-slate-900 text-white p-8 rounded-[2.5rem] shadow-xl relative overflow-hidden">
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  <button className="w-full bg-white/10 hover:bg-white/20 p-4 rounded-2xl flex items-center gap-4 transition-all backdrop-blur-sm border border-white/5 group">
